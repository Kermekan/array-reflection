...
const fs$2 = require$$3__default["default"];
...
Expecting one of '${allowedValues.join("', '")}'`);
  ...
  */
  ...
  _prepareUserArgs(argv, parseOptions) {
    ...
    this._name = this._name || (this._scriptPath && path$2.basename(this._scriptPath, path$2.extname(this._scriptPath)));
  ...
  _executeSubCommand(subcommand, args) {
    ...
    try {
      ...
      baseDir = path$2.dirname(resolvedLink);
    } catch (e) {
      baseDir = '.'; // dummy, probably not going to find executable!
    }

    // name of the subcommand, like `pm-install`
    let bin = path$2.basename(scriptPath, path$2.extname(scriptPath)) + '-' + subcommand._name;
    if (subcommand._executableFile) {
      bin = subcommand._executableFile;
    }

    const localBin = path$2.join(baseDir, bin);
    ...
    launchWithNode = sourceExt.includes(path$2.extname(bin));
...
var _path$3 = _interopRequireDefault$5(require$$0__default$1["default"]);
...
var _fs = _interopRequireDefault$4(require$$3__default["default"]);
...
var _path$2 = _interopRequireDefault$3(require$$0__default$1["default"]);
...
var _path$1 = _interopRequireDefault$2(require$$0__default$1["default"]);
...
var cosmiconfig_1 = dist$3.cosmiconfig = cosmiconfig;
dist$3.cosmiconfigSync = cosmiconfigSync;
dist$3.defaultLoaders = void 0;

var _os = _interopRequireDefault(require$$0__default$3["default"]);
...
dist$3.defaultLoaders = defaultLoaders;
...
var stringify_2 = dist.stringify = void 0;
...
stringify_2 = dist.stringify = stringify;
/**
...
function toCSS(object) {
    return stringify_2(object, (value, indent, stringify) => typeof value === 'string' ? value : stringify(value), 2)?.replace(/,\n/g, ';\n');
}
...
(async () => {
    const cliOpts = commander.exports.program.opts(), cosmic = cosmiconfig_1('pollen'), configResults = cliOpts?.config
        ? await cosmic.load(cliOpts.config)
        : await cosmic.search(), config = typeof configResults?.config === 'function'
        ? configResults.config(modules)
        : configResults?.config, outputPath = cliOpts?.output || config?.output || './pollen.css', cssMap = mapObject({ ...DEFAULTS, ...config?.modules }, (key, val) => {
        if (!val) {
    ...
    require$$3__default["default"].writeFileSync(require$$0__default$1["default"].resolve(process.cwd(), outputPath), `/**
